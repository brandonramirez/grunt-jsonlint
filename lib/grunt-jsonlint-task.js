 ...
 */
exports = module.exports = function makeTask(grunt, jsonlint, sorter, validator) {
  var FORMATTERS = {
      ...
      try {
        this.filesSrc.forEach(function (file) {
          ...
          try {
            ...
            var parsed = jsonlint.parse(data, {
            ...
            if ( options.format ) {
              ...
              var fmtd = JSON.stringify( parsed, null, options.indent ) + "\n";
